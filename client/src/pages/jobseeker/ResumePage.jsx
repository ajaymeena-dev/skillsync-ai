          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {hasResume && (
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-white/30 dark:bg-gray-800/80 dark:border-gray-700/50 shadow-sm overflow-hidden">
                <div className="p-6 border-b border-gray-200 dark:border-gray-800/50 bg-gradient-to-r from-indigo-50/50 to-indigo-50/50 dark:from-indigo-900/20 dark:to-indigo-900/20">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-600 to-indigo-600 flex items-center justify-center shadow-md">
          ...
          <div className="space-y-6">
            {hasResume && (
              <>
                ...
                <div className="bg-gradient-to-r from-indigo-600 to-indigo-600 rounded-2xl p-6 text-white relative overflow-hidden">
