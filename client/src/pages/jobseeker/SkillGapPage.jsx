        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
          ...
          <div className="max-w-lg mx-auto bg-white/80 backdrop-blur-sm rounded-2xl border border-white/30 p-6 sm:p-8 shadow-sm dark:bg-gray-800/80 dark:border-gray-700/50 text-center">
            ...
            <Button
              ...
              className="bg-gradient-to-r from-indigo-600 to-indigo-600 hover:from-indigo-700 hover:to-indigo-700 text-white gap-2 px-6"
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 mb-10 leading-relaxed">
              We found <span className="font-bold text-indigo-600 dark:text-indigo-400">{resumeSkills.length} skills</span> in your resume.
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Button
                ...
                size="lg"
                className="w-full sm:w-auto bg-gradient-to-r from-indigo-600 to-indigo-600 hover:from-indigo-700 hover:to-indigo-700 text-white gap-2 px-8 py-3 text-lg rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
              >
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
              ...
              <Card className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-md border border-gray-200/50 dark:border-gray-700/50 p-6 md:p-8 hover:shadow-xl transition-all duration-300 rounded-2xl group relative overflow-hidden">
                <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-indigo-500/10 to-indigo-500/10 rounded-bl-full -z-10" />
                <div className="w-14 h-14 rounded-2xl bg-indigo-100 dark:bg-indigo-900/30 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
    ...
    <div className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          ...
          <div className="group bg-white/80 backdrop-blur-sm rounded-2xl border border-white/30 p-5 sm:p-6 shadow-sm dark:bg-gray-800/80 dark:border-gray-700/50 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
            <div className="flex items-center justify-between mb-3">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-r from-indigo-600 to-indigo-600 flex items-center justify-center shadow-md group-hover:scale-110 transition-transform">
                      ...
                      >
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <Badge
                              variant="primary"
                              className="mb-2 text-xs bg-indigo-100 text-indigo-700 dark:bg-indigo-900/50 dark:text-indigo-400"
                            >
                              {resource.type}
                            </Badge>
                        ...
                        {resource.url ? (
                          ...
                          >
                            <Button
                              variant="outline"
                              size="sm"
                              className="w-full gap-1 border-gray-200 dark:border-gray-700 hover:border-indigo-200 dark:hover:border-indigo-700 hover:bg-indigo-50 hover:text-indigo-700 dark:hover:bg-indigo-900/20 dark:hover:text-indigo-300 transition-colors"
                            >
                              Start Learning{" "}
                          ...
                          <Button
                            variant="outline"
                            size="sm"
                            className="w-full mt-3 gap-1 border-gray-200 dark:border-gray-700 hover:border-indigo-200 dark:hover:border-indigo-700 hover:bg-indigo-50 hover:text-indigo-700 dark:hover:bg-indigo-900/20 dark:hover:text-indigo-300 transition-colors"
                          >
                            Start Learning{" "}
                            <ExternalLink className="w-3 h-3" />
                          </Button>
        ...
        <div className="bg-gradient-to-r from-indigo-600 to-indigo-600 rounded-2xl p-6 sm:p-8 relative overflow-hidden shadow-lg">
          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
            ...
            <Button
              ...
              className="bg-white text-indigo-600 hover:bg-gray-100 shadow-lg hover:shadow-xl transition-all px-6 gap-2 whitespace-nowrap"
            >
