...
const LandingPage = lazy(() =>
  import("../pages/marketing/LandingPage").then((m) => ({
    default: m.LandingPage,
  })),
);
const FeaturesPage = lazy(() =>
  import("../pages/marketing/FeaturesPage").then((m) => ({
    default: m.FeaturesPage,
  })),
);
const AboutPage = lazy(() =>
  import("../pages/marketing/AboutPage").then((m) => ({
    default: m.AboutPage,
  })),
);
const ContactPage = lazy(() =>
  import("../pages/marketing/ContactPage").then((m) => ({
    default: m.ContactPage,
  })),
);
const TestimonialsPage = lazy(() =>
  import("../pages/marketing/TestimonialsPage").then((m) => ({
...
const Dashboard = lazy(() =>
  import("../pages/jobseeker/Dashboard").then((m) => ({
    default: m.Dashboard,
  })),
);
const JobsPage = lazy(() =>
  import("../pages/jobseeker/JobsPage").then((m) => ({ default: m.JobsPage })),
);
...
const ResumePage = lazy(() =>
  import("../pages/jobseeker/ResumePage").then((m) => ({
    default: m.ResumePage,
  })),
);
const SkillGapPage = lazy(() =>
  import("../pages/jobseeker/SkillGapPage").then((m) => ({
    default: m.SkillGapPage,
  })),
);
const RoadmapPage = lazy(() =>
  import("../pages/jobseeker/RoadmapPage").then((m) => ({
    default: m.RoadmapPage,
  })),
);
const ProfilePage = lazy(() =>
  import("../pages/jobseeker/ProfilePage").then((m) => ({
    default: m.ProfilePage,
  })),
);
const MyApplicationsPage = lazy(() =>
  import("../pages/jobseeker/MyApplicationsPage").then((m) => ({
...
const RecruiterDashboard = lazy(() =>
  import("../pages/recruiter/RecruiterDashboard").then((m) => ({
    default: m.RecruiterDashboard,
  })),
);
const CandidatesListPage = lazy(() =>
  import("../pages/recruiter/CandidatesListPage").then((m) => ({
    default: m.CandidatesListPage,
  })),
);
const CandidateProfile = lazy(() =>
  import("../pages/recruiter/CandidateProfile").then((m) => ({
    default: m.CandidateProfile,
  })),
);
const PostedJobsPage = lazy(() =>
  import("../pages/recruiter/PostedJobsPage").then((m) => ({
...
const CompanyPage = lazy(() =>
  import("../pages/recruiter/CompanyPage").then((m) => ({
    default: m.CompanyPage,
  })),
);
const PublicCompanyPage = lazy(() =>
  import("../pages/recruiter/PublicCompanyPage").then((m) => ({
    default: m.PublicCompanyPage,
  })),
);
const JobApplicationsPage = lazy(() =>
  import("../pages/recruiter/JobApplicationsPage").then((m) => ({
...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: "verify-email", element: SimpleLoadable(VerifyEmailPage)() },
      {
        ...
        element: SimpleLoadable(ForgotPasswordPage)(),
      },
      ...
      // Protected Routes (require authentication)
      {
        ...
        children: [
          ...
          { path: "jobs/:jobId", element: Loadable(JobDetailsPage)() },
          {
            ...
            element: Loadable(PublicCompanyPage)(),
          },
